...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'api/AppLeadsApi', 'api/CompanyApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./api/AppLeadsApi'), require('./api/CompanyApi'));
  }
}(function(ApiClient, AppLeadsApi, CompanyApi) {
  'use strict';
  ...
  var exports = {
    ...
    ApiClient: ApiClient,
    /**
     * The AppLeadsApi service constructor.
     * @property {module:api/AppLeadsApi}
     */
    AppLeadsApi: AppLeadsApi,
    /**
